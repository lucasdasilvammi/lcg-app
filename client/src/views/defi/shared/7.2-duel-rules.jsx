...
export default function DuelRules({ roomData, currentUserId, acknowledgeRules }) {
  ...
  return (
    <div className="max-w-110 flex flex-col justify-between items-center h-screen py-16 px-6 text-center">
      ...
      <div className='flex flex-col gap-8'>
        {readerPlayer && <CharacterTag charId={readerPlayer.character} />}
