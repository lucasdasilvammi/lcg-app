...
function PlusOneBadge() {
  return (
    <span className="absolute -right-3 -top-3 rotate-9 flex h-8 w-8 items-center justify-center text-green-primary">
      <svg
        width="39"
        height="37"
        viewBox="0 0 39 37"
...
export default function BonusRewardCard({ bonus, className = '' }) {
