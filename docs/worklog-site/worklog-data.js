...
window.WORKLOG_PENDING_ITEMS = [
  ...
  },
  {
    ...
    "humanReview": true,
    "reviewNote": "A verifier en vraie partie pour confirmer le ressenti joueur, les messages et les cas longs non couverts par les tests automatiques.",
    "details": [
      "Section: Vérification release / Bonus",
      ...
      "Element non coche dans la TODO.",
      "Nuance bonus: pour l'IA, les scenarios critiques testes sont valides; cette carte reste une verification humaine ou un cas complementaire.",
      "Priorite automatique: V1."
    ],
    "files": []
  },
